<?php
namespace HMinng\Validator\Base;

use Countable;
use HMinng\Validator\Contracts\JsonableInterface;
use HMinng\Validator\Contracts\ArrayableInterface;
use HMinng\Validator\Contracts\MessageProviderInterface;
...
class MessageBag implements ArrayableInterface, Countable, JsonableInterface, MessageProviderInterface
{
	 ...
	 *
	 * @param  \HMinng\Validator\Contracts\MessageProviderInterface array  $messages
	 * @return \HMinng\Validator\Base\MessageBag
	 */
