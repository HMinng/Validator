<?php
use HMinng\Validator\Verifier\DatabasePresenceVerifier;

class DemoRule extends AtsRuleBaseClass
{
    ...
    protected static function messages() {
        $messages = array(
            ...
            'password.between'                  => '验证此规则的值必须在给定的 min 和 max 之间<span style="color:#F00;">[between]</span>',
        );
    ...
    protected static function setPresenceVerifier(\HMinng\Validator\Base\Validator $validator)
    {
        ...
        $databasePresenceVerifier = new DatabasePresenceVerifier();
        $databasePresenceVerifier->setConnection('test');
